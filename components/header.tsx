...
import { LeLoLogo } from "./aetheros-logo";
    ...
    >
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          >
            Features
            <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-[rgb(0,128,128)] transition-all duration-200 group-hover:w-5"></span>
          </a>
          <a
            href="#pricing"
            className="relative text-foreground/80 hover:text-foreground transition-all duration-300 group px-3 py-1 rounded-lg hover:bg-foreground/5 transform hover:scale-110 hover:-rotate-1 hover:-skew-x-1"
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="bg-teal-300 hover:bg-teal-500 text-primary-foreground transform transition-all duration-200 hover:scale-105 hover:shadow-lg rounded-xl"
          >
            Get Started
          </Button>
        </div>
