  ...
  return (
    <section className="py-12 md:py-20 px-4 relative overflow-hidden min-h-screen flex flex-col justify-between">
      <div className="flex-1 flex items-center justify-center pt-8 md:pt-20 pb-8 md:pb-0">
        <ParticleTextEffect words={["AI Operating System", "AetherOS"]} />
      </div>

      <div className="container mx-auto text-center relative z-10 pb-4 md:pb-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 md:mb-12">
            <Button
              size="lg"
              className="bg-teal-300 hover:bg-teal-500 text-black group cursor-pointer"
            >
              Start Free Trial
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-gray-600 text-white hover:border-teal-300 bg-transparent cursor-pointer"
            >
              Watch Demo
            </Button>
          </div>
            ...
            <div className="group relative m-auto max-w-6xl">
              <div className="flex flex-col items-center md:flex-row">
                <div className="md:max-w-44 md:border-r md:border-gray-600 md:pr-6 mb-4 md:mb-0">
                  <p className="text-end text-teal-300 font-semibold mb-2">
                    Powering the best teams
                  </p>
                </div>
                <div className="relative py-6 md:w-[calc(100%-11rem)]">
                  <InfiniteSlider durationOnHover={40} duration={20} gap={80}>
                    <div className="flex">
                      <img
